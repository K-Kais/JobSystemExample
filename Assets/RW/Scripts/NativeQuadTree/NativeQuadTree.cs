...
namespace NativeQuadTree
{
	...
	public unsafe partial struct NativeQuadTree<T> : IDisposable where T : unmanaged
	{
        ...
        QuadBounds bounds; // NOTE: Currently assuming uniform
		...
		/// </summary>
		public NativeQuadTree(QuadBounds bounds, Allocator allocator = Allocator.Temp, int maxDepth = 6, short maxLeafElements = 16,
