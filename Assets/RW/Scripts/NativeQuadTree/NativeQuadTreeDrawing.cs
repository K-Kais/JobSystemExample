...
namespace NativeQuadTree
{
	...
	{
		public static void Draw(NativeQuadTree<T> tree, NativeList<QuadElement<T>> results, QuadBounds range,
			Color[][] texture)
        {
		...
		static void DrawBounds(Color[][] texture, QuadBounds bounds, NativeQuadTree<T> tree)
		{
			var widthMult = texture.Length / tree.bounds.Extents.x * 2 / 2 / 2;
			var heightMult = texture[0].Length / tree.bounds.Extents.y * 2 / 2 / 2;
